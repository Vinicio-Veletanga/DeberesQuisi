      ...
      private void OnLoad(object sender, EventArgs e)
        {
         ...
         autoEnv.LoadFromResource("RouterFormsExampleForCLIPSdotNetCore", "RouterFormsExampleForCLIPSdotNetCore.auto.clp");
         autoEnv.LoadFromResource("RouterFormsExampleForCLIPSdotNetCore", "RouterFormsExampleForCLIPSdotNetCore.auto_en.clp");

         this.animalTextBox.AttachRouter(animalEnv, 10);
         animalEnv.LoadFromResource("RouterFormsExampleForCLIPSdotNetCore", "RouterFormsExampleForCLIPSdotNetCore.bcengine.clp");
         animalEnv.LoadFromResource("RouterFormsExampleForCLIPSdotNetCore", "RouterFormsExampleForCLIPSdotNetCore.animal.clp");
         animalEnv.LoadFromResource("RouterFormsExampleForCLIPSdotNetCore", "RouterFormsExampleForCLIPSdotNetCore.animal_en.clp");
