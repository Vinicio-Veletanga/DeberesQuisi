...
namespace AnimalFormsExampleForCLIPSdotNetCore
{
    public partial class AnimalFormsExample : Form
    {
        ...
        {
            InitializeComponent();
            clips.LoadFromResource("AnimalFormsExampleForCLIPSdotNetCore", "AnimalFormsExampleForCLIPSdotNetCore.bcengine.clp");
            clips.LoadFromResource("AnimalFormsExampleForCLIPSdotNetCore", "AnimalFormsExampleForCLIPSdotNetCore.animal.clp");
            clips.LoadFromResource("AnimalFormsExampleForCLIPSdotNetCore", "AnimalFormsExampleForCLIPSdotNetCore.animal_en.clp");
            clips.Reset();
        }
        ...
        private void HandleResponse()
        {
            ...
            String messageString = ((StringValue)fv.GetFactSlot("display")).ToString();
        ...
        /* ComputeLabelWidth */
        /*********************/
        private int ComputeLabelWidth(String theString)
        {
            Size theSize;
