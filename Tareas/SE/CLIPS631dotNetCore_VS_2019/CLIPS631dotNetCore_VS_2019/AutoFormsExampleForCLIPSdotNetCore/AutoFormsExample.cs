   ...
   public partial class AutoFormsExample : Form
     {
      ...
      public AutoFormsExample()
        {
         InitializeComponent();
         clips.LoadFromResource("AutoFormsExampleForCLIPSdotNetCore", "AutoFormsExampleForCLIPSdotNetCore.auto.clp");
         clips.LoadFromResource("AutoFormsExampleForCLIPSdotNetCore", "AutoFormsExampleForCLIPSdotNetCore.auto_en.clp");
         clips.Reset();  
        }
